...
public class FriendsAPI {
	 ...
	 */
	public static boolean isFriendsOf(String playername1, String playername2) {
	 ...
	 * @return Returns the names of friends of the player in an Array
	 */
	 ...
	 *         </ul>
	 */
	public static int[] getUserSettings(String player) {
		return Main.main.verbindung.einstellungenAbfragen(player);
